      ...
      <table className="w-full border-collapse">
        ...
        <thead>
          <tr className="border-b border-border">
            <th className="pb-1.5 text-xs font-bold text-primary text-right whitespace-nowrap pr-1">VONDS市原</th>
            <th className="pb-1.5" />
            <th className="pb-1.5 text-xs font-bold text-muted-foreground text-left whitespace-nowrap pl-1">{opponent}</th>
          </tr>
        </thead>
        <tbody>
          {ITEMS.map(({ key, label }) => {
            ...
            return (
              <>
                <tr key={`${key}-val`}>
                  <td className="pt-2 text-sm font-bold tabular-nums text-right whitespace-nowrap pr-1" style={{width:"1%"}}>
                  ...
                  <td className="pt-2 text-sm font-bold tabular-nums text-left whitespace-nowrap pl-1" style={{width:"1%"}}>
